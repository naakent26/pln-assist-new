...
///
/// Note:
/// On linux, we use dbus to communicate between multiple plnassist processes.
...
const DBUS_NAME: &str = "org.plnassist.plnassist";
...
impl fmt::Display for DbusError {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "PLNAssist DBus Error: {}", self.0)
    }
}
...
/// `dbus-send --session --print-reply --dest=org.plnassist.plnassist /dbus org.plnassist.plnassist.NewConnection string:'PEER_ID'`
