...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Подключение к сети PLNAssist..."),
        ...
        ("install_tip", "В некоторых случаях из-за UAC PLNAssist может работать неправильно на удалённом узле. Чтобы избежать возможных проблем с UAC, нажмите кнопку ниже для установки PLNAssist в системе."),
        ("Click to upgrade", "Нажмите, чтобы обновить"),
        ("Configure", "Настроить"),
        ("config_acc", "Чтобы удалённо управлять своим рабочим столом, вы должны предоставить PLNAssist права \"доступа\""),
        ("config_screen", "Для удалённого доступа к рабочему столу вы должны предоставить PLNAssist права \"снимок экрана\""),
        ...
        ("android_input_permission_tip1", "Чтобы удалённое устройство могло управлять вашим Android-устройством с помощью мыши или нажатий, необходимо разрешить PLNAssist использовать службу \"Специальные возможности\"."),
        ("android_input_permission_tip2", "Перейдите на соответствующую страницу системных настроек, найдите и войдите в \"Установленные службы\", включите службу \"PLNAssist Input\"."),
        ...
        ("Turned off", "Отключён"),
        ("Language", "Язык"),
        ("Keep PLNAssist background service", "Держать в фоне службу PLNAssist"),
        ...
        ("Show PLNAssist", "Показать PLNAssist"),
        ...
        ("config_input", "Чтобы управлять удалённым рабочим столом с помощью клавиатуры, необходимо предоставить PLNAssist разрешения \"Мониторинг ввода\"."),
        ("config_microphone", "Чтобы разговаривать с удалённой стороной, необходимо предоставить PLNAssist разрешение \"Запись аудио\"."),
        ...
        ("still_click_uac_tip", "По-прежнему требуется, чтобы удалённый пользователь нажал \"OK\" в окне UAC при запуске PLNAssist."),
        ...
        ("verify_plnassist_password_tip", "Подтвердить пароль PLNAssist"),
        ...
        ("scam_text1", "Если вы разговариваете по телефону с кем-то, кого вы НЕ ЗНАЕТЕ и НЕ ДОВЕРЯЕТЕ, и он просит вас использовать PLNAssist и запустить его службу, не продолжайте и немедленно прервите разговор."),
        ...
        ("upgrade_plnassist_server_pro_to_{}_tip", "Обновите PLNAssist Server Pro до версии {} или новее!"),
        ...
        ("selinux_tip", "На вашем устройстве включён SELinux, что может помешать правильной работе PLNAssist на управляемой стороне."),
        ("Change view", "Вид"),
        ...
        ("powered_by_me", "Основано на PLNAssist"),
        ...
        ("allow-only-conn-window-open-tip", "Разрешать подключение только при открытом окне PLNAssist"),
        ...
        ("floating_window_tip", "Помогает поддерживать фоновую службу PLNAssist"),
        ...
        ("upgrade_remote_plnassist_client_to_{}_tip", "Обновите клиент PLNAssist до версии {} или новее на удалённой стороне!"),
        ...
        ("allow-insecure-tls-fallback-tip", "По умолчанию PLNAssist проверяет сертификат сервера на наличие протоколов, использующих TLS.\nЕсли эта функция включена, PLNAssist пропустит данный этап и продолжит работу в случае неудачной проверки."),
        ("Disable UDP", "Отключить UDP"),
        ("disable-udp-tip", "Определяет, следует ли использовать только TCP.\nЕсли включено, PLNAssist не будет использовать UDP 21116, вместо него будет использоваться TCP 21116."),
        ("server-oss-not-support-tip", "ПРИМЕЧАНИЕ: в OSS-сервере PLNAssist эта функция отсутствует."),
