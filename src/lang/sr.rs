...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Zbog UAC PLNAssist ne može raditi pravilno u nekim slučajevima. Da biste prevazišli UAC, kliknite taster ispod da instalirate PLNAssist na sistem."),
        ("Click to upgrade", "Klik za nadogradnju"),
        ("Configure", "Konfigurisanje"),
        ("config_acc", "Da biste daljinski kontrolisali radnu površinu, PLNAssist-u treba da dodelite \"Accessibility\" prava."),
        ("config_screen", "Da biste daljinski pristupili radnoj površini, PLNAssist-u treba da dodelite \"Screen Recording\" prava."),
        ...
        ("android_input_permission_tip1", "Da bi daljinski uređaj kontrolisao vaš Android uređaj preko miša ili na dodir, treba da dozvolite PLNAssist-u da koristi \"Accessibility\" servis."),
        ("android_input_permission_tip2", "Molimo pređite na sledeću stranicu sistemskih podešavanja, pronađite i unesite [Installed Services], uključite [PLNAssist Input] servis."),
        ...
        ("android_open_battery_optimizations_tip", "Ako želite da onemogućite ovu funkciju, molimo idite na sledeću stranicu za podešavanje PLNAssist aplikacije, pronađite i uđite u [Battery], isključite [Unrestricted]"),
        ...
        ("Show PLNAssist", "Prikazi PLNAssist"),
        ("This PC", "Ovaj PC"),
        ("or", "ili"),
        ("Elevate", "Izdigni"),
        ...
        ("config_input", "Da biste upravljali udaljenom radnom površinom tastaturom, potrebno je da dodelite PLNAssist-u dozvolu \"Praćenje unosa\"."),
        ("config_microphone", "Da biste govorili na daljinu, potrebno je da dodelite PLNAssist-u dozvolu \"Snimanje zvuka\"."),
        ...
        ("still_click_uac_tip", "I dalje zahteva da udaljeni korisnik klikne OK na UAC prozoru pokrenutog PLNAssist-a."),
        ...
        ("verify_plnassist_password_tip", "Potvrdi PLNAssist lozinku"),
        ...
        ("scam_text1", "Ako razgovarate telefonom sa nekim koga NE poznajete I kome NE VERUJETE, a ko vas je zamolio da koristite PLNAssist i pokrenete servis, nemojte nastaviti i odmah prekinite vezu."),
        ...
        ("upgrade_plnassist_server_pro_to_{}_tip", "Molimo nadogradite PLNAssist Server Pro na verziju {} ili noviju!"),
        ...
        ("selinux_tip", "SELinux je omogućen na vašem uređaju, što može sprečiti PLNAssist da radi pravilno kao kontrolisana strana."),
        ...
        ("allow-only-conn-window-open-tip", "Dozvoli konekciju samo ako je PLNAssist prozor otvoren"),
        ...
        ("floating_window_tip", "Pomaže da se PLNAssist pozadinski servis održi"),
        ...
        ("upgrade_remote_plnassist_client_to_{}_tip", "Molimo nadogradite PLNAssist klijent na verziju {} ili noviju na udaljenoj strani!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Podrazumevano, PLNAssist proverava sertifikat servera za protokole koji koriste TLS.\nSa omogućenom ovom opcijom, PLNAssist će preskočiti korak provere i nastaviti u slučaju neuspele provere."),
        ("Disable UDP", "Onemogući UDP"),
        ("disable-udp-tip", "Kontroliše da li se koristi samo TCP.\nKada je ova opcija omogućena, PLNAssist više neće koristiti UDP 21116, umesto toga će se koristiti TCP 21116."),
        ("server-oss-not-support-tip", "NAPOMENA: PLNAssist server OSS ne uključuje ovu funkciju."),
