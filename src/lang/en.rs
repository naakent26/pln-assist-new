...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connecting to the PLNAssist network..."),
        ...
        ("install_tip", "Due to UAC, PLNAssist can not work properly as the remote side in some cases. To avoid UAC, please click the button below to install PLNAssist to the system."),
        ("config_acc", "In order to control your Desktop remotely, you need to grant PLNAssist \"Accessibility\" permissions."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant PLNAssist \"Screen Recording\" permissions."),
        ...
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow PLNAssist to use the \"Accessibility\" service."),
        ("android_input_permission_tip2", "Please go to the next system settings page, find and enter [Installed Services], turn on [PLNAssist Input] service."),
        ...
        ("doc_mac_permission", "https://plnassist.com/docs/en/client/mac/#enable-permissions"),
        ("Ignore Battery Optimizations", "Ignore battery optimizations"),
        ("android_open_battery_optimizations_tip", "If you want to disable this feature, please go to the next PLNAssist application settings page, find and enter [Battery], Uncheck [Unrestricted]"),
        ...
        ("config_input", "In order to control remote desktop with keyboard, you need to grant PLNAssist \"Input Monitoring\" permissions."),
        ("config_microphone", "In order to speak remotely, you need to grant PLNAssist \"Record Audio\" permissions."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running PLNAssist."),
        ...
        ("verify_plnassist_password_tip", "Verify PLNAssist password"),
        ...
        ("scam_text1", "If you are on the phone with someone you DON'T know AND TRUST who has asked you to use PLNAssist and start the service, do not proceed and hang up immediately."),
        ...
        ("upgrade_plnassist_server_pro_to_{}_tip", "Please upgrade PLNAssist Server Pro to version {} or newer!"),
        ("pull_group_failed_tip", "Failed to refresh group"),
        ("doc_fix_wayland", "https://plnassist.com/docs/en/client/linux/#x11-required"),
        ("display_is_plugged_out_msg", "The display is plugged out, switch to the first display."),
        ("selinux_tip", "SELinux is enabled on your device, which may prevent PLNAssist from running properly as controlled side."),
        ...
        ("powered_by_me", "Powered by PLNAssist"),
        ...
        ("allow-only-conn-window-open-tip", "Only allow connection if PLNAssist window is open"),
        ...
        ("floating_window_tip", "It helps to keep PLNAssist background service"),
        ...
        ("upgrade_remote_plnassist_client_to_{}_tip", "Please upgrade the PLNAssist client to version {} or newer on the remote side!"),
        ...
        ("allow-insecure-tls-fallback-tip", "By default, PLNAssist verifies the server certificate for protocols using TLS.\nWith this option enabled, PLNAssist will fall back to skipping the verification step and proceed in case of verification failure."),
        ("disable-udp-tip", "Controls whether to use TCP only.\nWhen this option enabled, PLNAssist will not use UDP 21116 any more, TCP 21116 will be used instead."),
        ("server-oss-not-support-tip", "NOTE: PLNAssist server OSS doesn't include this feature."),
