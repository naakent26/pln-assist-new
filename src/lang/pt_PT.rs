...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "A ligar à rede do PLNAssist..."),
        ...
        ("install_tip", "Devido ao UAC, o PLNAssist não funciona correctamente em alguns casos. Para evitar o UAC, por favor clique no botão abaixo para instalar o PLNAssist no sistema."),
        ("Click to upgrade", "Clique para atualizar"),
        ("Configure", "Configurar"),
        ("config_acc", "Para controlar o seu Ambiente de Trabalho remotamente, é preciso conceder ao PLNAssist permissões de \"Acessibilidade\"."),
        ("config_screen", "Para aceder ao seu Ambiente de Trabalho remotamente, é preciso conceder ao PLNAssist permissões de \"Gravar a Tela\"/"),
        ...
        ("android_input_permission_tip1", "Para que um dispositivo remoto controle o seu dispositivo Android via rato ou toque, você precisa permitir que o PLNAssist use o serviço \"Acessibilidade\"."),
        ("android_input_permission_tip2", "Por favor vá para a próxima página de configuração do sistema, encontre e entre [Serviços Instalados], ACTIVE o serviço [PLNAssist Input]."),
        ...
        ("Language", "Linguagem"),
        ("Keep PLNAssist background service", "Manter o serviço PLNAssist em funcionamento"),
        ("Ignore Battery Optimizations", "Ignorar optimizações de Bateria"),
        ("android_open_battery_optimizations_tip", "Se pretender desativar esta funcionalidade, aceda à próxima página de definições da aplicação PLNAssist, encontre e abra [Bateria], e desmarque [Sem restrições]"),
        ...
        ("Show PLNAssist", "Mostrar PLNAssist"),
        ("This PC", "Este PC"),
        ("or", "ou"),
        ("Elevate", "Elevar"),
        ...
        ("config_input", "Para controlar o ambiente de trabalho remoto com o teclado, é necessário conceder ao PLNAssist as permissões de \"Monitorização de Entrada\"."),
        ("config_microphone", "Para falar à distância, é necessário conceder ao PLNAssist as permissões de \"Gravar Áudio\"."),
        ...
        ("still_click_uac_tip", "Continua a exigir que o utilizador remoto clique em OK na janela do UAC do PLNAssist em execução."),
        ...
        ("verify_plnassist_password_tip", "Verificar palavra-passe do PLNAssist"),
        ...
        ("scam_text1", "Se estiver ao telefone com alguém que NÃO conhece NEM em quem confia e que lhe pediu para usar o PLNAssist e iniciar o serviço, não prossiga e desligue imediatamente."),
        ...
        ("upgrade_plnassist_server_pro_to_{}_tip", "Atualize o PLNAssist Server Pro para a versão {} ou mais recente!"),
        ...
        ("selinux_tip", "O SELinux está ativado no seu dispositivo, o que poderá impedir o PLNAssist de funcionar corretamente como lado controlado."),
        ...
        ("powered_by_me", "Disponibilizado pelo PLNAssist"),
        ...
        ("allow-only-conn-window-open-tip", "Permitir a ligação apenas se a janela do PLNAssist estiver aberta"),
        ...
        ("floating_window_tip", "Ajuda a manter o serviço em segundo plano do PLNAssist"),
        ...
        ("About PLNAssist", "Sobre o PLNAssist"),
        ...
        ("upgrade_remote_plnassist_client_to_{}_tip", "Atualize o cliente PLNAssist para a versão {} ou mais recente no lado remoto!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Por predefinição, o PLNAssist verifica o certificado do servidor para os protocolos que usam TLS.\nCom esta opção ativada, o PLNAssist recorrerá a ignorar a etapa de verificação e prosseguir em caso de falha de verificação."),
        ("Disable UDP", "Desativar UDP"),
        ("disable-udp-tip", "Controla se deve ser usado apenas TCP.\nQuando esta opção está ativada, o PLNAssist deixa de usar a UDP 21116, sendo usada a TCP 21116 em vez dela."),
        ("server-oss-not-support-tip", "NOTA: o PLNAssist server OSS não inclui esta funcionalidade."),
