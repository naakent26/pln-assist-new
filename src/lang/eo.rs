...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Konektante al la reto PLNAssist..."),
        ...
        ("install_tip", "Vi ne uzas instalita versio. Pro limigoj pro UAC, kiel aparato kontrolata, en kelkaj kazoj, ne estos ebla kontroli la muson kaj klavaron aŭ registri la ekranon. Bonvolu alkliku la butonon malsupre por instali PLNAssist sur la operaciumo por eviti la demando supre."),
        ("Click to upgrade", "Alklaki por plibonigi"),
        ("Configure", "Konfiguri"),
        ("config_acc", "Por uzi vian foran aparaton, bonvolu doni la permeson \"alirebleco\" al PLNAssist."),
        ("config_screen", "Por uzi vian foran aparaton, bonvolu doni la permeson \"ekranregistrado\" al PLNAssist."),
        ...
        ("android_input_permission_tip1", "Por ke fora aparato regu vian Android-aparaton per muso aŭ tuŝo, vi devas permesi al PLNAssist uzi la servon \"Alirebleco\"."),
        ("android_input_permission_tip2", "Bonvolu iri al la sekva paĝo de sistemaj agordoj, trovi kaj eniri [Instatajn Servojn], ŝalti la servon [PLNAssist Enigo]."),
        ...
        ("Language", "Lingvo"),
        ("Keep PLNAssist background service", "Tenu PLNAssist fonan servon"),
        ("Ignore Battery Optimizations", "Ignoru Bateria Optimumigojn"),
        ("android_open_battery_optimizations_tip", "Se vi volas malŝalti ĉi tiun funkcion, bonvolu iri al la sekva paĝo de agordoj de la aplikaĵo de PLNAssist, trovi kaj eniri [Baterio], Malmarku [Senrestrikta]"),
        ...
        ("Show PLNAssist", "Montri PLNAssist"),
        ...
        ("config_input", "Por kontroli la foran labortablon per klavaro, vi devas doni al PLNAssist permeson \"Eniga Monitorado\"."),
        ("config_microphone", "Por paroli fore, vi devas doni al PLNAssist permeson \"Registri Sonon\"."),
        ...
        ("still_click_uac_tip", "Ankoraŭ postulas ke la fora uzanto alklaku Bone en la UAC-fenestro de la funkcianta PLNAssist."),
        ...
        ("verify_plnassist_password_tip", "Kontroli PLNAssist-pasvorton"),
        ...
        ("scam_text1", "Se vi telefonas kun iu kiun vi NE konas KAJ FIDAS, kiu petis vin uzi PLNAssist kaj komenci la servon, ne daŭrigu kaj tuj malŝaltu la telefonon."),
        ...
        ("upgrade_plnassist_server_pro_to_{}_tip", "Bonvolu ĝisdatigi PLNAssist Server Pro al versio {} aŭ pli nova!"),
        ...
        ("selinux_tip", "SELinux estas ebligita sur via aparato, kio povas malhelpi PLNAssist funkcii ĝuste kiel kontrolata flanko."),
        ...
        ("powered_by_me", "Funkciigita de PLNAssist"),
        ...
        ("allow-only-conn-window-open-tip", "Permesi konekton nur se la fenestro de PLNAssist estas malfermita"),
        ...
        ("floating_window_tip", "Ĝi helpas teni la fonan servon de PLNAssist"),
        ...
        ("upgrade_remote_plnassist_client_to_{}_tip", "Bonvolu ĝisdatigi la PLNAssist-klienton al versio {} aŭ pli nova ĉe la fora flanko!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Implicite, PLNAssist kontrolas la servilan atestilon por protokoloj uzantaj TLS.\nKun ĉi tiu opcio ebligita, PLNAssist retrokadros al preterlaso de la kontrola paŝo kaj daŭrigos en kazo de kontrola malsukceso."),
        ("Disable UDP", "Malebligi UDP"),
        ("disable-udp-tip", "Regas ĉu uzi nur TCP.\nKiam ĉi tiu opcio estas ebligita, PLNAssist ne plu uzos UDP 21116, TCP 21116 estos uzata anstataŭe."),
        ("server-oss-not-support-tip", "NOTU: PLNAssist-servilo OSS ne inkluzivas ĉi tiun funkcion."),
