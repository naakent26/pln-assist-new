...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Vzpostavljanje povezave z omrežjem PLNAssist..."),
        ...
        ("install_tip", "Zaradi nadzora uporabniškega računa, PLNAssist v nekaterih primerih na oddaljeni strani ne deluje pravilno. Temu se lahko izognete z namestitvijo."),
        ("Click to upgrade", "Klikni za nadgradnjo"),
        ("Configure", "Nastavi"),
        ("config_acc", "Za oddaljeni nadzor namizja morate PLNAssistu dodeliti pravico za dostopnost"),
        ("config_screen", "Za oddaljeni dostop do namizja morate PLNAssistu dodeliti pravico snemanje zaslona"),
        ...
        ("android_input_permission_tip1", "Za oddaljeni nadzor vaše naprave Android, je potrebno PLNAssistu dodeliti pravico za dostopnost."),
        ("android_input_permission_tip2", "Pojdite v sistemske nastavitve, poiščite »Nameščene storitve« in vklopite storitev »PLNAssist Input«."),
        ...
        ("Language", "Jezik"),
        ("Keep PLNAssist background service", "Ohrani PLNAssistovo storitev v ozadju"),
        ("Ignore Battery Optimizations", "Prezri optimizacije baterije"),
        ("android_open_battery_optimizations_tip", "Če želite izklopiti to možnost, pojdite v nastavitve aplikacije PLNAssist, poiščite »Baterija« in izklopite »Neomejeno«"),
        ...
        ("config_input", "PLNAssist potrebuje pravico »Nadzor vnosa« za nadzor oddaljenega namizja s tipkovnico."),
        ("config_microphone", "PLNAssist potrebuje pravico »Snemanje zvoka« za zajemanje zvoka."),
        ...
        ("verify_plnassist_password_tip", "Preveri geslo za PLNAssist"),
        ...
        ("scam_text1", "V primeru, da vas je nekdo, ki ga ne poznate in mu zaupate prosil, da uporabite PLNAssist, prekinite klic in program zaprite."),
        ("scam_text2", "PLNAssist omogoča popoln nadzor nad vašim računalnikom in telefonom, in se lahko uporabi za krajo vašega denarja ali pa zasebnih podatkov."),
        ...
        ("upgrade_plnassist_server_pro_to_{}_tip", "Prosimo, nadgradite PLNAssist Server Pro na različico {} ali novejšo."),
        ...
        ("powered_by_me", "Uporablja tehnologijo PLNAssist"),
        ...
        ("allow-only-conn-window-open-tip", "Dovoli povezavo samo če je okno PLNAssista odprto"),
        ...
        ("floating_window_tip", "Pomaga pri PLNAssist storitvi v ozadju"),
        ...
        ("upgrade_remote_plnassist_client_to_{}_tip", "Prosimo, nadgradite PLNAssist odjemalec na različico {} ali novejšo na oddaljeni strani."),
        ...
        ("allow-insecure-tls-fallback-tip", "Privzeto PLNAssist preverja strežniško potrdilo za protokole, ki uporabljajo TLS.\nKo je ta možnost omogočena, bo PLNAssist ob neuspelem preverjanju preskočil korak preverjanja in nadaljeval."),
        ("Disable UDP", "Onemogoči UDP"),
        ("disable-udp-tip", "Določa, ali naj se uporablja samo TCP.\nKo je ta možnost omogočena, PLNAssist ne bo več uporabljal UDP 21116, namesto tega bo uporabljen TCP 21116."),
        ("server-oss-not-support-tip", "OPOMBA: Strežnik PLNAssist OSS ne vključuje te funkcije."),
