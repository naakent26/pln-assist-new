...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "PLNAssisti võrguga ühendumine..."),
        ...
        ("install_tip", "Kasutajakonto kontrolli (UAC) tõttu ei saa PLNAssist mõnel juhul korralikult kaugjuhtimispoolena töötada. Kontrolli vältimiseks palun klõpsa alloleval nupul, et PLNAssist oma süsteemi paigaldada."),
        ("Click to upgrade", "Vajuta täiendamiseks"),
        ("Configure", "Seadista"),
        ("config_acc", "Töölaua kaugjuhtimiseks tuleb PLNAssistile anda \"juurdepääsetavuse\" õigused."),
        ("config_screen", "Töölaua kaugjuhtimiseks tuleb PLNAssistile anda \"ekraanisalvestuse\" õigused."),
        ...
        ("android_input_permission_tip1", "Selleks, et kaugseade saaks sinu Androidi seadet juhtida hiire või puute abil, pead andma PLNAssistile \"juurdepääsetavuse\" loa."),
        ("android_input_permission_tip2", "Palun mine järgmisele süsteemiseadete lehele, leia ja sisesta [Paigaldatud teenused], lülita teenus [PLNAssist Input] sisse."),
        ...
        ("Language", "Keel"),
        ("Keep PLNAssist background service", "Säilita PLNAssisti taustateenus"),
        ("Ignore Battery Optimizations", "Ignoreeri akuoptimeerimisi"),
        ("android_open_battery_optimizations_tip", "Kui soovid selle funktsiooni keelata, palun mine järgmisele PLNAssisti rakenduse seadete lehele, leia ja sisesta [Aku], eemalda linnuke valikult [Piiramata]"),
        ...
        ("config_input", "Kaugtöölaua klaviatuuriga juhtimiseks pead andma PLNAssistile \"sisendi jälgimise\" õigused."),
        ("config_microphone", "Kaugelt rääkimiseks pead andma PLNAssistile \"heli salvestamise\" õigused."),
        ...
        ("still_click_uac_tip", "Kaugkasutaja peab siiski ise vajutama käitatud PLNAssisti kasutajakonto kontrollis (UAC) OK-nuppu."),
        ...
        ("verify_plnassist_password_tip", "Kinnita PLNAssisti parool"),
        ...
        ("scam_text1", "Kui räägid telefoniga kellegagi, keda EI TUNNE ja EI USALDA, kes on palunud sul PLNAssisti kasutada ja teenus käivitada, ära jätka ning lõpeta kõne koheselt."),
        ...
        ("upgrade_plnassist_server_pro_to_{}_tip", "Palun täienda PLNAssist Server Pro versioonile {} või uuem!"),
        ...
        ("selinux_tip", "SELinux on su seadmes lubatud, mis võib PLNAssistil takistada juhitud poolel toimimist."),
        ...
        ("powered_by_me", "Põhineb PLNAssistil"),
        ...
        ("allow-only-conn-window-open-tip", "Luba ühendus ainult siis, kui PLNAssisti aken on avatud."),
        ...
        ("floating_window_tip", "See aitab säilitada PLNAssisti taustateenust."),
        ...
        ("About PLNAssist", "PLNAssisti teave"),
        ...
        ("upgrade_remote_plnassist_client_to_{}_tip", "Täiendage PLNAssisti klient kaugküljel versioonile {} või uuemale!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Vaikimisi kontrollib PLNAssist TLS-i kasutavate protokollide puhul serveri sertifikaati.\nKui see valik on lubatud, jätab PLNAssist kontrollimissammu vahele ja jätkab kontrolli ebaõnnestumise korral."),
        ("Disable UDP", "Keela UDP"),
        ("disable-udp-tip", "Määrab, kas kasutada ainult TCP-d.\nKui see valik on lubatud, ei kasuta PLNAssist enam UDP 21116, vaid kasutatakse selle asemel TCP 21116."),
        ("server-oss-not-support-tip", "MÄRKUS: PLNAssisti serveri OSS ei sisalda seda funktsiooni."),
