...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Opretter tilkobling til PLNAssist-nettverket..."),
        ...
        ("install_tip", "På grunn av UAC kan PLNAssist ikke fungere korrekt i enkelte tillfeller på fjernskrivebordet. For å unngå UAC klikker du på knappen nedenfor for å installere PLNAssist på systemet"),
        ("Click to upgrade", "Klikk for å oppgradere"),
        ("Configure", "Konfigurer"),
        ("config_acc", "For å kontrollere ditt skrivebord med fjernstyring må du gi PLNAssist \"Access \" Rettigheter."),
        ("config_screen", "For å kunne få adgang til ditt skrivebord med fjernstyring, må du gi PLNAssist \"skjerstøtte \" tillatelser."),
        ...
        ("android_input_permission_tip1", "For at en ekstern enhet kan kontrollere din Android-enhet via mus eller berøring, må du gi PLNAssist mulighet til å bruke tjenesten \"tilgjengelighet \"."),
        ("android_input_permission_tip2", "Gå til den neste systeminnstillingssiden, søk og tast inn [installerte tjenester], aktiver [PLNAssist Input] tjenesten."),
        ...
        ("android_open_battery_optimizations_tip", "Hvis du vil deaktivere denne funksjonen, gå til neste innstillingsside for PLNAssist-applikasjonen, finn og åpne [Batteri], og fjern haken ved [Ubegrenset]."),
        ...
        ("config_input", "For å kunne styre fjernskrivebordet med tastatur må du gi PLNAssist tillatelsen \"Inndataovervåking\"."),
        ("config_microphone", "For å kunne snakke eksternt må du gi PLNAssist tillatelsen \"Ta opp lyd\"."),
        ...
        ("still_click_uac_tip", "Krever fortsatt at fjernbrukeren klikker OK på UAC-vinduet til den kjørende PLNAssist."),
        ...
        ("verify_plnassist_password_tip", "Verifiser PLNAssist-passord"),
        ...
        ("scam_text1", "Hvis du snakker i telefonen med noen du IKKE kjenner OG STOLER PÅ, som har bedt deg om å bruke PLNAssist og starte tjenesten, ikke fortsett og legg på umiddelbart."),
        ...
        ("upgrade_plnassist_server_pro_to_{}_tip", "Vennligst oppgrader PLNAssist Server Pro til versjon {} eller nyere!"),
        ...
        ("selinux_tip", "SELinux er aktivert på enheten din, noe som kan hindre PLNAssist i å fungere som det skal på den kontrollerte siden."),
        ...
        ("powered_by_me", "Drevet av PLNAssist"),
        ...
        ("allow-only-conn-window-open-tip", "Tillat kun tilkobling hvis PLNAssist-vinduet er åpent"),
        ...
        ("floating_window_tip", "Det bidrar til å holde PLNAssist-bakgrunnstjenesten i gang"),
        ...
        ("upgrade_remote_plnassist_client_to_{}_tip", "Vennligst oppgrader PLNAssist-klienten til versjon {} eller nyere på fjernsiden!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Som standard verifiserer PLNAssist serversertifikatet for protokoller som bruker TLS.\nMed dette alternativet aktivert vil PLNAssist falle tilbake til å hoppe over verifiseringstrinnet og fortsette ved verifiseringsfeil."),
        ("Disable UDP", "Deaktiver UDP"),
        ("disable-udp-tip", "Styrer om kun TCP skal brukes.\nNår dette alternativet er aktivert, vil PLNAssist ikke lenger bruke UDP 21116, TCP 21116 brukes i stedet."),
        ("server-oss-not-support-tip", "MERK: PLNAssist server OSS inkluderer ikke denne funksjonen."),
