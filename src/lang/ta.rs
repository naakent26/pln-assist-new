...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("android_input_permission_tip1", "PLNAssist இந்த Android சாதனத்தை கட்டுப்படுத்த \"அணுகல் சேவைகள்\" அனுமதி தேவை."),
        ("android_input_permission_tip2", "சிஸ்டம் அமைப்புகளில் [நிறுவப்பட்ட சேவைகள்] கண்டுபிடித்து, PLNAssist சேவை இயக்கவும்."),
        ...
        ("Language", "மொழி"),
        ("Keep PLNAssist background service", "PLNAssist பின்புல சேவையை வைத்திரு"),
        ("Ignore Battery Optimizations", "பேட்டரி மேம்படுத்தல்களை புறக்கணி"),
        ("android_open_battery_optimizations_tip", "PLNAssist க்கு பேட்டரி மேம்படுத்தல் அணைக்க அமைப்புகளுக்கு செல்லவும்"),
        ...
        ("Show PLNAssist", "PLNAssist ஐ காட்டு"),
        ("This PC", "இந்த PC"),
        ("or", "அல்லது"),
        ("Elevate", "உயர்த்து"),
        ...
        ("verify_plnassist_password_tip", "plnassist_கடவுச்சொல்_சரிபார்ப்பு_குறிப்பு"),
        ...
        ("scam_text2", "PLNAssist ஊழியர் இவ்வாறு தொடர்பு கொள்ள மாட்டார்கள்"),
        ...
        ("upgrade_plnassist_server_pro_to_{}_tip", "PLNAssist Server Pro {} க்கு மேம்படுத்து"),
        ...
        ("selinux_tip", "SELinux இயக்கப்பட்டது, PLNAssist அனுமதி வேண்டும்"),
        ...
        ("enable-2fa-desc", "PLNAssist இரு காரணி அங்கீகாரம் ஆதரிக்கிறது"),
        ...
        ("upgrade_remote_plnassist_client_to_{}_tip", "ரிமோட்_plnassist_கிளையன்டை_{}_மேம்படுத்து_குறிப்பு"),
        ...
        ("allow-insecure-tls-fallback-tip", "இயல்பாக, TLS ஐப் பயன்படுத்தும் நெறிமுறைகளுக்கு PLNAssist சர்வர் சான்றிதழை சரிபார்க்கிறது.\nஇந்த விருப்பம் இயக்கப்பட்டால், சரிபார்ப்பு தோல்வியடைந்தால் PLNAssist சரிபார்ப்பு படிநிலையைத் தவிர்த்து தொடரும்."),
        ("Disable UDP", "UDP ஐ முடக்கு"),
        ("disable-udp-tip", "TCP ஐ மட்டுமே பயன்படுத்த வேண்டுமா என்பதைக் கட்டுப்படுத்துகிறது.\nஇந்த விருப்பம் இயக்கப்பட்டால், PLNAssist இனி UDP 21116 ஐப் பயன்படுத்தாது, அதற்குப் பதிலாக TCP 21116 பயன்படுத்தப்படும்."),
        ("server-oss-not-support-tip", "குறிப்பு: PLNAssist சர்வர் OSS இந்த அம்சத்தை உள்ளடக்கவில்லை."),
