...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Notiek savienojuma izveide ar PLNAssist tīklu..."),
        ...
        ("install_tip", "UAC dēļ PLNAssist dažos gadījumos nevar pareizi darboties kā attālā puse. Lai izvairītos no UAC, lūdzu, noklikšķiniet uz tālāk esošās pogas, lai instalētu PLNAssist sistēmā."),
        ("Click to upgrade", "Jaunināt"),
        ("Configure", "Konfigurēt"),
        ("config_acc", "Lai attālināti vadītu savu darbvirsmu, jums ir jāpiešķir PLNAssist \"Pieejamība\" atļaujas."),
        ("config_screen", "Lai attālināti piekļūtu darbvirsmai, jums ir jāpiešķir PLNAssist \"Ekrāna tveršana\" atļaujas."),
        ...
        ("android_input_permission_tip1", "Lai attālā ierīce varētu vadīt jūsu Android ierīci, izmantojot peli vai pieskārienu, jums ir jāatļauj PLNAssist izmantot servisu \"Pieejamība\"."),
        ("android_input_permission_tip2", "Lūdzu, dodieties uz nākamo sistēmas iestatījumu lapu, atrodiet un atveriet [Instalētie pakalpojumi], ieslēdziet servisu [PLNAssist Input]."),
        ...
        ("Turned off", "Izslēgts"),
        ("Language", "Valoda"),
        ("Keep PLNAssist background service", "Saglabāt PLNAssist fona servisu"),
        ("Ignore Battery Optimizations", "Ignorēt akumulatora optimizāciju"),
        ("android_open_battery_optimizations_tip", "Ja vēlaties atspējot šo funkciju, lūdzu, dodieties uz nākamo PLNAssist lietojumprogrammas iestatījumu lapu, atrodiet un atveriet [Akumulators], noņemiet atzīmi no [Neierobežots]"),
        ...
        ("Show PLNAssist", "Rādīt PLNAssist"),
        ("This PC", "Šis dators"),
        ("or", "vai"),
        ("Elevate", "Pacelt"),
        ...
        ("config_input", "Lai vadītu attālo darbvirsmu ar tastatūru, jums ir jāpiešķir PLNAssist \"Ievades uzraudzība\" atļaujas."),
        ("config_microphone", "Lai runātu attālināti, jums ir jāpiešķir PLNAssist \"Ierakstīt audio\" atļaujas."),
        ...
        ("still_click_uac_tip", "Joprojām attālajam lietotājam ir jānoklikšķina uz Labi UAC logā, kurā darbojas PLNAssist."),
        ...
        ("verify_plnassist_password_tip", "Pārbaudīt PLNAssist paroli"),
        ...
        ("scam_text1", "Ja sarunājaties ar kādu, kuru nepazīstat un kurš ir lūdzis izmantot PLNAssist, lai sāktu pakalpojumu, neturpiniet un nekavējoties nolieciet klausuli."),
        ...
        ("upgrade_plnassist_server_pro_to_{}_tip", "Lūdzu, jauniniet PLNAssist Server Pro uz versiju {} vai jaunāku!"),
        ...
        ("selinux_tip", "Jūsu ierīcē ir iespējots SELinux, kas var neļaut PLNAssist pareizi darboties kā kontrolētajai pusei."),
        ...
        ("powered_by_me", "Darbojas ar PLNAssist"),
        ...
        ("allow-only-conn-window-open-tip", "Atļaut savienojumu tikai tad, ja ir atvērts PLNAssist logs"),
        ...
        ("floating_window_tip", "Tas palīdz uzturēt PLNAssist fona servisu"),
        ...
        ("upgrade_remote_plnassist_client_to_{}_tip", "Lūdzu, jauniniet attālās puses PLNAssist klientu uz versiju {} vai jaunāku!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Pēc noklusējuma PLNAssist pārbauda servera sertifikātu protokoliem, izmantojot TLS.\nJa šī opcija ir iespējota, PLNAssist izlaidīs verifikācijas soli un turpinās darbību verifikācijas kļūmes gadījumā."),
        ("Disable UDP", "Atspējot UDP"),
        ("disable-udp-tip", "Nosaka, vai izmantot tikai TCP.\nKad šī opcija ir iespējota, PLNAssist vairs neizmantos UDP 21116, tā vietā tiks izmantots TCP 21116."),
        ("server-oss-not-support-tip", "PIEZĪME. PLNAssist servera OSS neietver šo funkciju."),
