...
const String kWaylandKeyboardIssueUrl =
    'https://github.com/plnassist/plnassist/issues/14586';
...
List<TTextMenu> toolbarControls(BuildContext context, String id, FFI ffi) {
  ...
  // https://github.com/plnassist/plnassist/pull/9731
...
bool showVirtualDisplayMenu(FFI ffi) {
  ...
  if (ffi.ffiModel.pi.isPLNAssistIdd || ffi.ffiModel.pi.isAmyuniIdd) {
    return true;
  }
  return false;
}
...
List<Widget> getVirtualDisplayMenuChildren(
  ...
  final privacyModeState = PrivacyModeState.find(id);
  if (pi.isPLNAssistIdd) {
    final virtualDisplays = ffi.ffiModel.pi.PLNAssistVirtualDisplays;
