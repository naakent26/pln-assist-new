...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Ansluter till PLNAssist..."),
        ...
        ("install_tip", "På grund av UAC, kan inte PLNAssist fungera ordentligt på klientsidan. För att undvika problem med UAC, tryck på knappen nedan för att installera PLNAssist på systemet."),
        ("Click to upgrade", "Klicka för att nedgradera"),
        ("Configure", "Konfigurera"),
        ("config_acc", "För att kontrollera din dator på distans måste du ge PLNAssist \"Tillgänglighets\" rättigheter."),
        ("config_screen", "För att kontrollera din dator på distans måste du ge PLNAssist \"Skärminspelnings\" rättigheter."),
        ...
        ("android_input_permission_tip2", "Gå till systeminställningarna, hitta [Installed Services], sätt på [PLNAssist Input] tjänsten."),
        ...
        ("Turned off", "Avstängd"),
        ("Language", "Språk"),
        ("Keep PLNAssist background service", "Behåll PLNAssist i bakgrunden"),
        ("Ignore Battery Optimizations", "Ignorera batterioptimering"),
        ("android_open_battery_optimizations_tip", "Om du vill stänga av denna funktion, gå till nästa PLNAssist programs inställningar, hitta [Batteri], Checka ur [Obegränsad]"),
        ...
        ("config_input", "För att kunna styra fjärrskrivbordet med tangentbordet måste du ge PLNAssist behörigheten \"Övervaka inmatning\"."),
        ("config_microphone", "För att kunna tala på distans måste du ge PLNAssist behörigheten \"Spela in ljud\"."),
        ...
        ("still_click_uac_tip", "Kräver fortfarande att fjärranvändaren klickar på OK i UAC-fönstret för PLNAssist."),
        ...
        ("verify_plnassist_password_tip", "Verifiera PLNAssist-lösenord"),
        ...
        ("scam_text1", "Om du talar i telefon med någon du INTE känner OCH litar på, som har bett dig använda PLNAssist och starta tjänsten, fortsätt inte och lägg på omedelbart."),
        ...
        ("upgrade_plnassist_server_pro_to_{}_tip", "Uppgradera PLNAssist Server Pro till version {} eller senare!"),
        ...
        ("selinux_tip", "SELinux är aktiverat på din enhet, vilket kan hindra PLNAssist från att fungera korrekt som kontrollerad sida."),
        ("Change view", "Byt vy"),
        ...
        ("powered_by_me", "Drivs av PLNAssist"),
        ...
        ("allow-only-conn-window-open-tip", "Tillåt endast anslutning om PLNAssist-fönstret är öppet"),
        ...
        ("floating_window_tip", "Det hjälper till att hålla PLNAssist-bakgrundstjänsten igång"),
        ...
        ("upgrade_remote_plnassist_client_to_{}_tip", "Uppgradera PLNAssist-klienten till version {} eller senare på fjärrsidan!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Som standard verifierar PLNAssist serverns certifikat för protokoll som använder TLS.\nMed detta alternativ aktiverat hoppar PLNAssist över verifieringssteget och fortsätter om verifieringen misslyckas."),
        ("Disable UDP", "Inaktivera UDP"),
        ("disable-udp-tip", "Styr om endast TCP ska användas.\nNär detta alternativ är aktiverat använder PLNAssist inte längre UDP 21116, utan TCP 21116 används i stället."),
        ("server-oss-not-support-tip", "OBS: PLNAssist server OSS inkluderar inte denna funktion."),
