...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "กำลังเชื่อมต่อไปยังเครือข่าย PLNAssist..."),
        ...
        ("install_tip", "เนื่องด้วยข้อจำกัดของการใช้งาน UAC ทำให้ PLNAssist ไม่สามารถทำงานได้ปกติในฝั่งปลายทางในบางครั้ง เพื่อหลีกเลี่ยงข้อจำกัดของ UAC กรุณากดปุ่มด้านล่างเพื่อติดตั้ง PLNAssist ไปยังระบบของคุณ"),
        ("Click to upgrade", "คลิกเพื่ออัปเกรด"),
        ("Configure", "ปรับแต่งค่า"),
        ("config_acc", "เพื่อที่จะควบคุมเดสก์ท็อปปลายทางของคุณ คุณจำเป็นจะต้องอนุญาตสิทธิ์ \"การเข้าถึง\" ให้แก่ PLNAssist"),
        ("config_screen", "เพื่อที่จะควบคุมเดสก์ท็อปปลายทางของคุณ คุณจำเป็นจะต้องอนุญาตสิทธิ์ \"การบันทึกภาพหน้าจอ\" ให้แก่ PLNAssist"),
        ...
        ("android_input_permission_tip1", "ในการที่จะอนุญาตให้เครื่องปลายทางควบคุมอุปกรณ์แอนดรอยด์ของคุณโดยใช้เมาส์หรือการสัมผัส คุณจำเป็นจะต้องอนุญาตสิทธิ์ \"การเข้าถึง\" ให้แก่เซอร์วิสของ PLNAssist"),
        ("android_input_permission_tip2", "กรุณาไปยังหน้าตั้งค่าถัดไป ค้นหาและเข้าไปยัง [เซอร์วิสที่ถูกติดตั้ง] และเปิดการใช้งานเซอร์วิส [อินพุท PLNAssist]"),
        ...
        ("Turned off", "ปิด"),
        ("Language", "ภาษา"),
        ("Keep PLNAssist background service", "คงสถานะการทำงานเบื้องหลังของเซอร์วิส PLNAssist"),
        ("Ignore Battery Optimizations", "เพิกเฉยการตั้งค่าการใช้งาน Battery Optimization"),
        ("android_open_battery_optimizations_tip", "หากคุณต้องการปิดการใช้งานฟีเจอร์นี้ กรุณาไปยังหน้าตั้งค่าในแอปพลิเคชัน PLNAssist ค้นหาหัวข้อ [Battery] และยกเลิกการเลือกรายการ [Unrestricted]"),
        ...
        ("config_input", "เพื่อที่จะควบคุมเครื่องเดสก์ท็อปปลายทางด้วยคีย์บอร์ด คุณจำเป็นจะต้องอนุญาตสิทธิ์ \"การตรวจสอบ Input\" ให้แก่ PLNAssist"),
        ("config_microphone", "เพื่อที่จะส่งเสียงพูดไปยังปลายทาง คุณจำเป็นจะต้องอนุญาตสิทธิ์ \"การบันทึกเสียง\" ให้แก่ PLNAssist"),
        ...
        ("still_click_uac_tip", "ผู้ใช้งานปลายทางยังจำเป็นที่จะต้องกดปุ่ม ตกลง บนหน้าต่าง UAC ของ PLNAssist"),
        ...
        ("verify_plnassist_password_tip", "ยืนยันความถูกต้องรหัสผ่านของ PLNAssist"),
        ...
        ("scam_text1", "ถ้าคุณกำลังคุยโทรศัพท์กับคนที่คุณไม่รู้จักและไม่ไว้ใจ และคนๆนั้นกำลังขอให้คุณเปิดใช้งาน PLNAssist อย่าทำตามและรีบวางสายในทันที"),
        ...
        ("upgrade_plnassist_server_pro_to_{}_tip", "กรุณาอัปเดต PLNAssist Server Pro ไปยังเวอร์ชัน {} หรือใหม่กว่า!"),
        ...
        ("selinux_tip", "SELinux ถูกเปิดใช้งานบนอุปกรณ์ของคุณ ซึ่งอาจทำให้ PLNAssist ทำงานเป็นฝ่ายถูกควบคุมได้ไม่สมบูรณ์"),
        ...
        ("powered_by_me", "ขับเคลื่อนโดย PLNAssist"),
        ...
        ("allow-only-conn-window-open-tip", "อนุญาตการเชื่อมต่อเฉพาะเมื่อหน้าต่าง PLNAssist เปิดอยู่"),
        ...
        ("floating_window_tip", "ช่วยให้บริการเบื้องหลังของ PLNAssist ทำงานต่อเนื่อง"),
        ...
        ("About PLNAssist", "เกี่ยวกับ PLNAssist"),
        ...
        ("upgrade_remote_plnassist_client_to_{}_tip", "กรุณาอัปเดต PLNAssist ไคลเอนต์ไปยังเวอร์ชัน {} หรือใหม่กว่าที่ฝั่งปลายทาง!"),
        ...
        ("allow-insecure-tls-fallback-tip", "โดยค่าเริ่มต้น PLNAssist จะตรวจสอบใบรับรองของเซิร์ฟเวอร์สำหรับโปรโตคอลที่ใช้ TLS\nเมื่อเปิดใช้งานตัวเลือกนี้ PLNAssist จะย้อนกลับไปข้ามขั้นตอนการตรวจสอบและดำเนินการต่อในกรณีที่การตรวจสอบล้มเหลว"),
        ("Disable UDP", "ปิดใช้งาน UDP"),
        ("disable-udp-tip", "ควบคุมว่าจะใช้ TCP เท่านั้นหรือไม่\nเมื่อเปิดใช้งานตัวเลือกนี้ PLNAssist จะไม่ใช้ UDP 21116 อีกต่อไป และจะใช้ TCP 21116 แทน"),
        ("server-oss-not-support-tip", "หมายเหตุ: PLNAssist server OSS ไม่มีคุณสมบัตินี้"),
