...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connessione a sa rete PLNAssist..."),
        ...
        ("install_tip", "Pro neghe de su Controllu Contu Utente (UAC), PLNAssist diat pòdere non funtzionare comente si tocat comente iscrivania remota.\nPro evitare custu problema, incarca in su butone inoghe in suta pro installare PLNAssist a livellu de sistema."),
        ("Click to upgrade", "Atualiza"),
        ("Configure", "Cunfigura"),
        ("config_acc", "Pro controllare s'iscrivania dae foras, depes frunire a PLNAssist su permissu 'Atzessibilidade'."),
        ("config_screen", "Pro controllare s'iscrivania dae foras, depes frunire a PLNAssist su permissu 'Registratzione ischermu'."),
        ...
        ("android_input_permission_tip1", "Pro chi unu dispositivu remotu potzat controllare unu dispositivu Android pro mèdiu de unu ratu o cun su tocu, depes cunsentire a PLNAssist de impreare su servìtziu 'Atzessibilidade'."),
        ("android_input_permission_tip2", "Bae a sa pàgina de sas impostatziones de sistema chi s'at a abèrrere a pustis, busca e intra a [Servìtzios installados], allughe su servìtziu [Intrada PLNAssist]."),
        ...
        ("Turned off", "Istuda"),
        ("Language", "Limba"),
        ("Keep PLNAssist background service", "Mantene su servìtziu de PLNAssist in s'isfundu"),
        ("Ignore Battery Optimizations", "Ignora sas otimizatziones de sa bateria"),
        ("android_open_battery_optimizations_tip", "Si boles disabilitare custa funtzione, bae a sas impostatziones de s'aplicatzione PLNAssist, aberi sa setzione 'Bateria' e boga sa seletzione a 'Chene restritziones'."),
        ...
        ("Show PLNAssist", "Mustra PLNAssist"),
        ("This PC", "Custu PC"),
        ("or", "O"),
        ("Elevate", "Cresche"),
        ...
        ("config_input", "Pro controllare s'elaboradore remotu cun su tecladu bisòngiat a frunire a PLNAssist sos permissos de 'Monitoràgiu insertada'."),
        ("config_microphone", "Per pòdere mutire, bisòngiat a frunire su premissu 'Registra àudio' a PLNAssist."),
        ...
        ("still_click_uac_tip", "Torra a pedire chi s'utente remotu seletziones 'AB' in sa ventana UAC de s'esecutzione de PLNAssist."),
        ...
        ("verify_plnassist_password_tip", "Cunfirma sa crae de PLNAssist"),
        ...
        ("Exit", "Essi dae PLNAssist"),
        ("Open", "Aberi PLNAssist"),
        ...
        ("scam_text1", "Si ses in su telèfonu cun calicunu chi NON connosches NON FIDADU chi t'at pedidu de impreare PLNAssist e de allùghere su servìtziu, non sigas e tanca deretu."),
        ...
        ("upgrade_plnassist_server_pro_to_{}_tip", "Atualiza PLNAssist Server Pro a sa versione {} o prus noa!"),
        ...
        ("selinux_tip", "In custu dispositivu est abilitadu SELinux, chi diat pòdere su funtzionamentu curretu de PLNAssist comente ala controllada."),
        ...
        ("powered_by_me", "Alimentadu dae PLNAssist"),
        ...
        ("allow-only-conn-window-open-tip", "Permite sa connessione petzi si sa ventana PLNAssist est aberta"),
        ...
        ("floating_window_tip", "Agiudat a mantènnere su servìtziu in s'isfundu de PLNAssist"),
        ...
        ("About PLNAssist", "Informatziones subra de PLNAssist"),
        ...
        ("upgrade_remote_plnassist_client_to_{}_tip", "Atualiza su cliente PLNAssist remotu a sa versione {} o prus noa!"),
        ...
        ("allow-insecure-tls-fallback-tip", "De manera predefinida, PLNAssist averguat su certificadu de su serbidore pro sos protocollos chi impreant TLS.\nCun custa optzione ativada, PLNAssist at a brincare s'averguada e at a sighire in casu de faddina de averguada."),
        ("Disable UDP", "Disabìlita UDP"),
        ("disable-udp-tip", "Controllat si impreare petzi su TCP.\nCun custa optzione ativada, PLNAssist no at a impreare prus sa UDP 21116, ma at a impreare sa TCP 21116."),
        ("server-oss-not-support-tip", "NOTA: su serbidore OSS de PLNAssist non includet custa funtzione."),
