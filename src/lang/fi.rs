...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Yhdistetään PLNAssist verkkoon..."),
        ...
        ("install_tip", "Joissain tapauksissa PLNAssist ei toimi oikein etäpuolella UAC:n vuoksi. Välttääksesi tämän, napsauta alla olevaa painiketta asentaaksesi PLNAssistin järjestelmään."),
        ("Click to upgrade", "Päivitä napsauttamalla"),
        ("Configure", "Määritä"),
        ("config_acc", "Etätyöpöydän hallintaa varten sinun on annettava PLNAssistille ”Esteettömyys”-oikeudet."),
        ("config_screen", "Etätyöpöydän käyttöä varten sinun on annettava PLNAssistille ”Näytön tallennus” oikeudet."),
        ...
        ("Discovered", "Löydetty"),
        ("install_daemon_tip", "Palvelun automaattista käynnistystä varten PLNAssist daemon on asennettava järjestelmään."),
        ("Remote ID", "Etätunnus"),
        ("Paste", "Liitä"),
        ...
        ("android_input_permission_tip1", "Siirry Androidin asetuksiin ja ota PLNAssistille käyttöön 'Syötteen ohjaus' oikeus."),
        ("android_input_permission_tip2", "Jos et löydä asetusta, etsi 'Esteettömyys' ja salli PLNAssist ohjelman käyttö."),
        ("android_new_connection_tip", "Uusi yhteyspyyntö vastaanotettu."),
        ("android_service_will_start_tip", "PLNAssist palvelu käynnistyy taustalla."),
        ("android_stop_service_tip", "Pysäytä taustapalvelu tarvittaessa PLNAssistin asetuksista."),
        ("android_version_audio_tip", "Äänensiirto vaatii Android 10:n tai uudemman."),
        ("android_start_service_tip", "PLNAssist palvelu käynnistetään..."),
        ...
        ("Language", "Kieli"),
        ("Keep PLNAssist background service", "Pidä PLNAssistin taustapalvelu käynnissä"),
        ("Ignore Battery Optimizations", "Ohita akun optimoinnit"),
        ("android_open_battery_optimizations_tip", "Poista PLNAssistin akkuoptimointi, jotta yhteys pysyy vakaana taustalla."),
        ...
        ("Show PLNAssist", "Näytä PLNAssist"),
        ...
        ("verify_plnassist_password_tip", "Vahvista PLNAssist salasanasi kirjautumista varten"),
        ...
        ("scam_text2", "PLNAssist ei koskaan pyydä maksua tai etäkäyttöä ilman lupaasi."),
        ...
        ("upgrade_plnassist_server_pro_to_{}_tip", "Päivitä PLNAssist Server Pro versioon {} jatkaaksesi."),
        ...
        ("About PLNAssist", "Tietoa PLNAssististä"),
        ...
        ("upgrade_remote_plnassist_client_to_{}_tip", "Päivitä etä-PLNAssist-asiakasversioon {} yhteensopivuuden takaamiseksi"),
        ...
        ("allow-insecure-tls-fallback-tip", "Oletuksena PLNAssist vahvistaa palvelimen varmenteen TLS:ää käyttävissä protokollissa.\nKun tämä asetus on käytössä, PLNAssist ohittaa vahvistusvaiheen ja jatkaa toimintaa, jos vahvistus epäonnistuu."),
        ("Disable UDP", "Poista UDP käytöstä"),
        ("disable-udp-tip", "Määrittää, käytetäänkö vain TCP:tä.\nKun tämä asetus on käytössä, PLNAssist ei enää käytä UDP-porttia 21116, vaan sen sijaan käytetään TCP-porttia 21116."),
        ("server-oss-not-support-tip", "HUOMAUTUS: PLNAssist-palvelimen OSS ei sisällä tätä ominaisuutta."),
