...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Đang kết nối đến mạng lưới PLNAssist..."),
        ...
        ("install_tip", "Do cơ chế UAC, PLNAssist có thể không hoạt động ổn định ở phía người dùng từ xa trong một số trường hợp. Để tránh vấn đề này, vui lòng nhấn nút bên dưới để cài đặt PLNAssist vào hệ thống."),
        ("Click to upgrade", "Nhấn để nâng cấp"),
        ("Configure", "Cấu hình"),
        ("config_acc", "Để điều khiển từ xa, bạn cần cấp quyền \"Trợ năng\" cho PLNAssist."),
        ("config_screen", "Để truy cập từ xa, bạn cần cấp quyền \"Ghi màn hình\" cho PLNAssist."),
        ...
        ("android_input_permission_tip2", "Vui lòng tìm [Dịch vụ đã cài đặt] trong cài đặt và bật [PLNAssist Input]."),
        ...
        ("Turned off", "Đã tắt"),
        ("Language", "Ngôn ngữ"),
        ("Keep PLNAssist background service", "Giữ dịch vụ PLNAssist chạy nền"),
        ...
        ("verify_plnassist_password_tip", "Xác thực mật khẩu PLNAssist"),
        ...
        ("scam_text2", "Chỉ sử dụng PLNAssist với những người bạn thực sự tin tưởng."),
        ...
        ("upgrade_plnassist_server_pro_to_{}_tip", "Nâng cấp lên Pro để có thêm tính năng"),
        ...
        ("allow-only-conn-window-open-tip", "Chỉ cho phép khi cửa sổ PLNAssist mở"),
        ...
        ("floating_window_tip", "Giữ PLNAssist trên cùng"),
        ...
        ("upgrade_remote_plnassist_client_to_{}_tip", "Vui lòng nâng cấp đối tác lên {}"),
