...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Pripájam sa na PLNAssist server..."),
        ...
        ("install_tip", "V niektorých prípadoch PLNAssist nefunguje správne z dôvodu riadenia užívateľských oprávnení (UAC). Vyhnete sa tomu kliknutím na nižšie zobrazene tlačítko a nainštalovaním RuskDesk do systému."),
        ("Click to upgrade", "Kliknutím nainštalujete aktualizáciu"),
        ("Configure", "Nastaviť"),
        ("config_acc", "Aby bolo možné na diaľku ovládať vašu plochu, je potrebné aplikácii PLNAssist udeliť práva \"Dostupnosť\"."),
        ("config_screen", "Aby bolo možné na diaľku sledovať vašu obrazovku, je potrebné aplikácii PLNAssist udeliť práva \"Zachytávanie obsahu obrazovky\"."),
        ...
        ("android_input_permission_tip1", "Aby bolo možné na diaľku ovládať vašu plochu pomocou myši alebo dotykov, je potrebné aplikácii PLNAssist udeliť práva \"Dostupnosť\"."),
        ("android_input_permission_tip2", "Prejdite na stránku nastavení systému, nájdite a vstúpte do [Stiahnuté služby], zapnite [PLNAssist Input] službu."),
        ...
        ("Turned off", "Vypnutý"),
        ("Language", "Jazyk"),
        ("Keep PLNAssist background service", "Ponechať službu PLNAssist na pozadí"),
        ("Ignore Battery Optimizations", "Ignorovať optimalizácie batérie"),
        ("android_open_battery_optimizations_tip", "Ak chcete túto funkciu vypnúť, prejdite na ďalšiu stránku nastavení PLNAssistu, vyhľadajte a zadajte položku [Batéria], zrušte začiarknutie položky [Neobmedzené]."),
        ...
        ("Show PLNAssist", "Zobraziť PLNAssist"),
        ...
        ("config_input", "Ak chcete ovládať vzdialenú plochu pomocou klávesnice, musíte udeliť oprávnenie PLNAssist \"Sledovanie vstupu\"."),
        ("config_microphone", "Ak chcete hovoriť na diaľku, musíte PLNAssistu udeliť povolenie \"Nahrávať zvuk\"."),
        ...
        ("still_click_uac_tip", "Stále sa vyžaduje, aby vzdialený používateľ klikol na tlačidlo OK v okne UAC spusteného programu PLNAssist."),
        ...
        ("verify_plnassist_password_tip", "Overenie hesla PLNAssist"),
        ...
        ("scam_text1", "Ak telefonujete s niekým, koho nepoznáte a komu nedôverujete a kto vás požiadal o použitie a spustenie aplikácie PLNAssist, nepokračujte v hovore a okamžite zaveste."),
        ...
        ("upgrade_plnassist_server_pro_to_{}_tip", "Aktualizujte PLNAssist Server Pro na verziu {} alebo novšiu!"),
        ...
        ("selinux_tip", "Na vašom zariadení je povolený SELinux, čo môže brániť správnemu spusteniu PLNAssistu ako spravovanej strany."),
        ...
        ("powered_by_me", "Poháňané aplikáciou PLNAssist"),
        ...
        ("allow-only-conn-window-open-tip", "Povoliť pripojenie iba vtedy, ak je otvorené okno aplikácie PLNAssist"),
        ...
        ("floating_window_tip", "Pomáha udržiavať službu PLNAssist na pozadí"),
        ...
        ("upgrade_remote_plnassist_client_to_{}_tip", "Aktualizujte klienta PLNAssist na verziu {} alebo novšiu na vzdialenej strane!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Štandardne PLNAssist overuje certifikát servera pre protokoly používajúce TLS.\nS touto možnosťou PLNAssist v prípade zlyhania overenia preskočí krok overovania a bude pokračovať."),
        ("Disable UDP", "Vypnúť UDP"),
        ("disable-udp-tip", "Určuje, či sa má používať iba TCP.\nKeď je táto možnosť povolená, PLNAssist už nebude používať UDP 21116, namiesto neho sa použije TCP 21116."),
        ("server-oss-not-support-tip", "POZNÁMKA: PLNAssist server OSS túto funkciu neobsahuje."),
