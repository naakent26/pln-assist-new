...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "Prêt"),
        ("Established", "Établie"),
        ("connecting_status", "Connexion au réseau PLNAssist…"),
        ...
        ("install_tip", "PLNAssist n’est pas installé, ce qui peut limiter son utilisation à cause de l’UAC. Cliquez ci-dessous pour l’installer."),
        ...
        ("android_input_permission_tip1", "Pour qu’un appareil distant puisse contrôler votre appareil Android via la souris ou le toucher d’écran, vous devez autoriser PLNAssist à utiliser le service « Accessibilité »."),
        ("android_input_permission_tip2", "Veuillez accéder à la page suivante des paramètres système, puis recherchez et accédez à la section [Services installés] ; activez ensuite le service [PLNAssist Input]."),
        ...
        ("Language", "Langue"),
        ("Keep PLNAssist background service", "Garder le service PLNAssist en arrière plan"),
        ("Ignore Battery Optimizations", "Ignorer les optimisations de la batterie"),
        ("android_open_battery_optimizations_tip", "Pour désactiver cette fonctionnalité, veuillez accéder à la page suivante des paramètres de l’application PLNAssist, puis recherchez et accédez à la section [Batterie] ; décochez ensuite l’option [Sans restriction]."),
        ...
        ("Show PLNAssist", "Afficher PLNAssist"),
        ("This PC", "Ce PC"),
        ("or", "ou"),
        ...
        ("config_input", "Vous devez accorder à PLNAssist l’autorisation « Surveillance de l’entrée » pour contrôler le bureau distant avec le clavier."),
        ("config_microphone", "Vous devez accorder à PLNAssist l’autorisation « Enregistrer l’audio » pour discuter à distance."),
        ...
        ("still_click_uac_tip", "L’utilisateur distant devra malgré tout confirmer l’UAC de l’instance PLNAssist en cours d’éxécution."),
        ...
        ("verify_plnassist_password_tip", "Vérifier le mot de passe PLNAssist"),
        ...
        ("scam_text1", "Si vous êtes au téléphone avec quelqu’un QUE VOUS NE CONNAISSEZ PAS et en qui VOUS N’AVEZ PAS CONFIANCE et qui vous a demandé d’utiliser PLNAssist et de démarrer le service, ne le faites pas et raccrochez immédiatement."),
        ...
        ("upgrade_plnassist_server_pro_to_{}_tip", "Veuillez mettre à jour PLNAssist Server Pro vers la version {} ou une version ultérieure !"),
        ...
        ("selinux_tip", "SELinux est activé sur votre appareil, ce qui peut empêcher PLNAssist de fonctionner correctement sur la machine contrôlée."),
        ...
        ("powered_by_me", "Utilise la technologie PLNAssist"),
        ...
        ("allow-only-conn-window-open-tip", "N’autoriser la connexion que si la fenêtre PLNAssist est ouverte"),
        ...
        ("About PLNAssist", "À propos de PLNAssist"),
        ...
        ("upgrade_remote_plnassist_client_to_{}_tip", "Veuillez mettre le client PLNAssist distant à jour vers la version {} ou ultérieure !"),
        ...
        ("allow-insecure-tls-fallback-tip", "Par défaut, PLNAssist vérifie le certificat du serveur lors de l’utilisation de protocoles utilisant TLS.\nLorsque cette option est activée, PLNAssist autorise les connexions même en cas d’échec de l’étape de vérification."),
        ("Disable UDP", "Désactiver UDP"),
        ("disable-udp-tip", "Contrôle l’utilisation exclusive du mode TCP.\nLorsque cette option est activée, PLNAssist n’utilise plus le port UDP 21116 et utilise le port TCP 21116 à la place."),
        ("server-oss-not-support-tip", "Note : Cette fonctionnalité n’est pas disponible sous la version open-source du serveur PLNAssist."),
