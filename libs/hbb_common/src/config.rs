...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("PLN Assist".to_owned());
...
pub const LINK_DOCS_HOME: &str = "https://plnassist.com/docs/en/";
pub const LINK_DOCS_X11_REQUIRED: &str = "https://plnassist.com/docs/en/manual/linux/#x11-required";
pub const LINK_HEADLESS_LINUX_SUPPORT: &str =
    "https://github.com/plnassist/plnassist/wiki/Headless-Linux-Support";

lazy_static::lazy_static! {
    pub static ref HELPER_URL: HashMap<&'static str, &'static str> = HashMap::from([
        ("plnassist docs home", LINK_DOCS_HOME),
        ("plnassist docs x11-required", LINK_DOCS_X11_REQUIRED),
        ("plnassist x11 headless", LINK_HEADLESS_LINUX_SUPPORT),
        ]);
}
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["rs-ny.plnassist.com"];
