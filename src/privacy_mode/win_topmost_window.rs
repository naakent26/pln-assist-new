...
pub const WIN_TOPMOST_INJECTED_PROCESS_EXE: &'static str = "RuntimeBroker_plnassist.exe";
pub const INJECTED_PROCESS_EXE: &'static str = WIN_TOPMOST_INJECTED_PROCESS_EXE;
pub(super) const PRIVACY_WINDOW_CLASS: &'static str = "PLNAssistPrivacyWindowClass";
pub(super) const PRIVACY_WINDOW_NAME: &'static str = "PLNAssistPrivacyWindow";
...
const WM_PLNASSIST_SHOW_WINDOWS: u32 = WM_APP + 3;
const WM_PLNASSIST_HIDE_WINDOWS: u32 = WM_APP + 4;
...
fn set_privacy_windows_visible(hwnds: &[HWND], show: bool) -> ResultType<usize> {
    ...
    let message = if show {
        WM_PLNASSIST_SHOW_WINDOWS
    } else {
        WM_PLNASSIST_HIDE_WINDOWS
    };
    let mut posted = 0;
