...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Menghubungkan ke PLNAssist..."),
        ...
        ("install_tip", "Karena UAC, PLNAssist tidak dapat bekerja dengan baik sebagai sisi remote dalam beberapa kasus. Untuk menghindari UAC, silakan klik tombol di bawah ini untuk menginstal PLNAssist ke sistem."),
        ("Click to upgrade", "Klik untuk upgrade"),
        ("Configure", "Konfigurasi"),
        ("config_acc", "Agar bisa mengontrol Desktopmu dari jarak jauh, Kamu harus memberikan izin \"Aksesibilitas\" untuk PLNAssist."),
        ("config_screen", "Agar bisa mengakses Desktopmu dari jarak jauh, kamu harus memberikan izin \"Perekaman Layar\" untuk PLNAssist."),
        ...
        ("android_input_permission_tip1", "Agar perangkat jarak jauh dapat mengontrol perangkat Android melalui mouse atau sentuhan, Kamu harus memberikan izin/permission kd PLNAssist untuk menggunakan layanan \"Aksesibilitas\"."),
        ("android_input_permission_tip2", "Silakan buka halaman pengaturan sistem berikutnya, temukan dan masuk ke [Layanan Terinstal], aktifkan layanan [Input PLNAssist]."),
        ...
        ("Language", "Bahasa"),
        ("Keep PLNAssist background service", "Pertahankan PLNAssist berjalan pada service background"),
        ...
        ("Show PLNAssist", "Tampilkan PLNAssist"),
        ("This PC", "PC ini"),
        ("or", "atau"),
        ("Elevate", "Elevasi"),
        ...
        ("config_input", "Untuk menggunakan input keyboard remote, anda perlu memberikan izin \"Pemantauan Input\" pada PLNAssist"),
        ("config_microphone", "Untuk berbicara secara remote, anda perlu memberikan izin \"Rekam Audio\" pada PLNAssist"),
        ...
        ("still_click_uac_tip", "Masih memerlukan persetujuan pihak pengguna remote untuk mengklik OK pada jendela UAC PLNAssist yang sedang berjalan"),
        ...
        ("verify_plnassist_password_tip", "Verifikasi Kata Sandi PLNAssist"),
        ...
        ("scam_text1", "Jika anda sedang berbicara di telepon dengan seseorang yang TIDAK dikenal dan mereka meminta anda untuk menggunakan PLNAssist, jangan lanjutkan dan segera tutup panggilan."),
        ...
        ("upgrade_plnassist_server_pro_to_{}_tip", "Silahkan perbarui PLNAssist Server Pro ke versi {} atau yang lebih baru!"),
        ...
        ("selinux_tip", "pada perangkat anda, SELinux sedang aktif, yang mana itu dapat mencegah PLNAssist berfungsi dengan baik sebagai sisi yang dikontrol."),
        ...
        ("powered_by_me", "Didukung oleh PLNAssist"),
        ...
        ("allow-only-conn-window-open-tip", "Koneksi hanya diperbolehkan jika jendela PLNAssist sedang terbuka."),
        ...
        ("floating_window_tip", "Untuk menjaga layanan/service PLNAssist agar tetap aktif"),
        ...
        ("About PLNAssist", "Tentang PLNAssist"),
        ...
        ("upgrade_remote_plnassist_client_to_{}_tip", "Silahkan perbarui aplikasi PLNAssist ke versi {} atau yang lebih baru pada komputer yang akan terhubung!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Secara default, PLNAssist memverifikasi sertifikat server untuk protokol yang menggunakan TLS.\nDengan opsi ini diaktifkan, PLNAssist akan kembali melewati langkah verifikasi dan melanjutkan jika verifikasi gagal."),
        ("Disable UDP", "Nonaktifkan UDP"),
        ("disable-udp-tip", "Mengontrol apakah hanya menggunakan TCP.\nSaat opsi ini diaktifkan, PLNAssist tidak akan menggunakan UDP 21116 lagi, TCP 21116 akan digunakan sebagai gantinya."),
        ("server-oss-not-support-tip", "CATATAN: PLNAssist server OSS tidak menyertakan fitur ini."),
