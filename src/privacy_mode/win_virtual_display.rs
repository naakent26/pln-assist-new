...
impl PrivacyModeImpl {
    ...
    // mainly from https://github.com/plnassist-org/plnassist/blob/44c3a52ca8502cf53b58b59db130611778d34dbe/libs/scrap/src/dxgi/mod.rs#L365
    ...
    fn restore(&mut self) {
        ...
        if is_virtual_display_added {
            ...
            // https://github.com/plnassist/plnassist/pull/12114#issuecomment-2983054370
