...
class _AboutState extends State<_About> {
  ...
  Widget build(BuildContext context) {
    return futureBuilder(future: () async {
      ...
      return SingleChildScrollView(
        controller: scrollController,
        child: _Card(title: translate('About PLNAssist'), children: [
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              const SizedBox(
              ...
              InkWell(
                  onTap: () {
                    launchUrlString('https://plnassist.com/privacy.html');
                  },
                  child: Text(
              ...
              InkWell(
                  onTap: () {
                    launchUrlString('https://plnassist.com');
                  },
                  child: Text(
                    translate('Website'),
                    style: linkStyle,
...
class _WaylandCardState extends State<WaylandCard> {
  ...
  //   "Settings" -> "Apps" -> "PLNAssist" -> "Permissions" -> "Inhibit Shortcuts".
  // For resetting(clearing) the permission from the portal permission store, you can
  // use (replace <desktop-id> with the PLNAssist desktop file ID):
  ...
  // On a native install this is typically "plnassist.desktop"; on Flatpak it is usually
  // the exported desktop ID derived from the Flatpak app-id (e.g. "com.plnassist.PLNAssist.desktop").
  //
