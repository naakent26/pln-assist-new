...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Prisijungiama prie PLNAssist tinklo..."),
        ...
        ("install_tip", "Kai kuriais atvejais UAC gali priversti PLNAssist netinkamai veikti nuotoliniame pagrindiniame kompiuteryje. Norėdami apeiti UAC, spustelėkite toliau esantį mygtuką, kad įdiegtumėte PLNAssist į savo kompiuterį."),
        ("Click to upgrade", "Spustelėkite, jei norite atnaujinti"),
        ("Configure", "Konfigūruoti"),
        ("config_acc", "Norėdami nuotoliniu būdu valdyti darbalaukį, turite suteikti PLNAssist \"prieigos\" leidimus"),
        ("config_screen", "Norėdami nuotoliniu būdu pasiekti darbalaukį, turite suteikti PLNAssist leidimus \"ekrano kopija\""),
        ("Installing ...", "Diegiama ..."),
        ("Install", "Diegti"),
        ...
        ("install_daemon_tip", "Norėdami, kad PLNAssist startuotų automatiškai, turite ją įdiegti"),
        ...
        ("android_input_permission_tip1", "Kad nuotolinis įrenginys galėtų valdyti Android įrenginį pele arba liesti, turite leisti PLNAssist naudoti \"Prieinamumo\" paslaugą."),
        ("android_input_permission_tip2", "Eikite į kitą sistemos nustatymų puslapį, suraskite \"Įdiegtos paslaugos\" ir įgalinkite \"PLNAssist įvestis\" paslaugą."),
        ...
        ("Turned off", "Išjungti"),
        ("Language", "Kalba"),
        ("Keep PLNAssist background service", "Palikti PLNAssist fonine paslauga"),
        ...
        ("Show PLNAssist", "Rodyti PLNAssist"),
        ...
        ("config_input", "Norėdami valdyti nuotolinį darbalaukį naudodami klaviatūrą, turite suteikti PLNAssist leidimus \"Įvesties monitoringas\"."),
        ("config_microphone", "Norėdami kalbėtis su nuotoline puse, turite suteikti PLNAssist leidimą \"Įrašyti garsą\"."),
        ...
        ("still_click_uac_tip", "Vis tiek reikia, kad nuotolinis vartotojas paleidžiant PLNAssist UAC lange paspaustų \"OK\"."),
        ...
        ("verify_plnassist_password_tip", "Įveskite kliento PLNAssist slaptažodį"),
        ...
        ("scam_text1", "Jei kalbatės telefonu su žmogumi, kurio NEPAŽĮSTATE ir kuriuo NEPASITIKITE, ir jis paprašė jūsų naudoti PLNAssist bei paleisti paslaugą, netęskite ir nedelsdami padėkite ragelį."),
        ...
        ("upgrade_plnassist_server_pro_to_{}_tip", "Prašome atnaujinti PLNAssist Server Pro į versiją {} ar naujesnę!"),
        ...
        ("selinux_tip", "Jūsų įrenginyje įjungtas SELinux, kuris gali trukdyti PLNAssist tinkamai veikti kaip valdomajai pusei."),
        ...
        ("powered_by_me", "Veikia su PLNAssist"),
        ...
        ("allow-only-conn-window-open-tip", "Leisti prisijungti tik tada, kai atidarytas PLNAssist langas"),
        ...
        ("floating_window_tip", "Tai padeda išlaikyti PLNAssist foninę paslaugą"),
        ...
        ("About PLNAssist", "Apie PLNAssist"),
        ...
        ("upgrade_remote_plnassist_client_to_{}_tip", "Prašome atnaujinti nuotolinės pusės PLNAssist klientą į {} ar naujesnę versiją!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Pagal numatytuosius nustatymus PLNAssist tikrina serverio sertifikatą protokoluose, naudojančiuose TLS.\nĮgalinus šią parinktį, patikros nesėkmės atveju PLNAssist praleis patikros veiksmą ir tęs darbą."),
        ("Disable UDP", "Išjungti UDP"),
        ("disable-udp-tip", "Nurodo, ar naudoti tik TCP.\nĮgalinus šią parinktį, PLNAssist nebenaudos UDP 21116, vietoj jo bus naudojamas TCP 21116."),
        ("server-oss-not-support-tip", "PASTABA: PLNAssist serverio OSS šios funkcijos neturi."),
