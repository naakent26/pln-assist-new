...
class FfiModel with ChangeNotifier {
  ...
  bool shouldAutoRetryOnOffline(
    ...
    if (type == 'error' &&
      ...
      // https://github.com/plnassist/plnassist/discussions/14048
  ...
  handlePlatformAdditions(
    ...
    if (updateData.isEmpty) {
      _pi.platformAdditions.remove(kPlatformAdditionsPLNAssistVirtualDisplays);
      ...
      try {
        ...
        if (!updateJson
            .containsKey(kPlatformAdditionsPLNAssistVirtualDisplays)) {
          _pi.platformAdditions
              .remove(kPlatformAdditionsPLNAssistVirtualDisplays);
        }
  ...
  void setViewOnly(String id, bool value) {
    ...
    // tmp fix for https://github.com/plnassist/plnassist/pull/3706#issuecomment-1481242389
...
class PeerInfo with ChangeNotifier {
  ...
  List<int> get PLNAssistVirtualDisplays => List<int>.from(
      platformAdditions[kPlatformAdditionsPLNAssistVirtualDisplays] ?? []);
  ...
  bool get isPLNAssistIdd =>
      platformAdditions[kPlatformAdditionsIddImpl] == 'plnassist_idd';
