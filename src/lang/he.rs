...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "מוכן"),
        ("Established", "מחובר"),
        ("connecting_status", "מתחבר לרשת PLNAssist..."),
        ...
        ("install_tip", "בגלל UAC, PLNAssist לא יכול לפעול כראוי כצד מרוחק בחלק מהמקרים. כדי להימנע מ-UAC, אנא לחץ על הכפתור למטה כדי להתקין את PLNAssist במערכת."),
        ("Click to upgrade", "לחץ כדי לשדרג"),
        ("Configure", "הגדר"),
        ("config_acc", "כדי לשלוט מרחוק בשולחן העבודה שלך, עליך להעניק ל-PLNAssist הרשאות \"נגישות\"."),
        ("config_screen", "כדי לגשת מרחוק לשולחן העבודה שלך, עליך להעניק ל-PLNAssist הרשאות \"הקלטת מסך\"."),
        ("Installing ...", "מתקין ..."),
        ("Install", "התקן"),
        ("Installation", "התקנה"),
        ...
        ("android_input_permission_tip1", "כדי שמכשיר מרוחק יוכל לשלוט במכשיר האנדרואיד שלך באמצעות עכבר או מגע, עליך לאפשר ל-PLNAssist להשתמש בשירות \"נגישות\"."),
        ("android_input_permission_tip2", "אנא עבור לדף הגדרות המערכת הבא, מצא והכנס ל[שירותים מותקנים], הפעל את שירות [PLNAssist Input]."),
        ...
        ("Turned off", "מכובה"),
        ("Language", "שפה"),
        ("Keep PLNAssist background service", "השאר את שירות הרקע של PLNAssist פעיל"),
        ("Ignore Battery Optimizations", "התעלם מאופטימיזציות סוללה"),
        ("android_open_battery_optimizations_tip", "אם ברצונך לבטל תכונה זו, אנא עבור לדף ההגדרות של יישום PLNAssist , מצא והיכנס ל[סוללה], ובטל את הסימון מ-[לא מוגבל]"),
        ...
        ("Show PLNAssist", "הצג את PLNAssist"),
        ("This PC", "מחשב זה"),
        ("or", "או"),
        ...
        ("config_input", "כדי לשלוט בשולחן העבודה המרוחק באמצעות מקלדת, עליך להעניק ל-PLNAssist הרשאות \"מעקב קלט\"."),
        ("config_microphone", "כדי לדבר מרחוק, עליך להעניק ל-PLNAssist הרשאות \"הקלטת שמע\"."),
        ...
        ("still_click_uac_tip", "עדיין נדרש מהמשתמש המרוחק לאשר את חלון ה-UAC של PLNAssist"),
        ...
        ("verify_plnassist_password_tip", "אמת סיסמת PLNAssist"),
        ...
        ("scam_text1", "אם אתה בשיחת טלפון עם מישהו שאינך מכיר ואינך סומך עליו שביקש ממך להשתמש ב-PLNAssist ולהתחיל את השירות, אל תמשיך ונתק מיד."),
        ...
        ("upgrade_plnassist_server_pro_to_{}_tip", "אנא שדרג את PLNAssist Server Pro לגרסה {} או חדשה יותר!"),
        ...
        ("selinux_tip", "SELinux מופעל במכשיר שלך, מה שעלול למנוע מ-PLNAssist לפעול כראוי כצד הנשלט."),
        ...
        ("About PLNAssist", "אודות PLNAssist"),
        ...
        ("upgrade_remote_plnassist_client_to_{}_tip", "אנא שדרג את לקוח PLNAssist לגרסה {} או חדשה יותר בצד המרוחק!"),
        ...
        ("allow-insecure-tls-fallback-tip", "כברירת מחדל, PLNAssist מאמת את אישור השרת עבור פרוטוקולים המשתמשים ב-TLS.\nכאשר אפשרות זו מופעלת, PLNAssist יחזור לדילוג על שלב האימות וימשיך במקרה של כשל באימות."),
        ("Disable UDP", "השבת UDP"),
        ("disable-udp-tip", "קובע אם להשתמש ב-TCP בלבד.\nכאשר אפשרות זו מופעלת, PLNAssist לא ישתמש יותר ב-UDP 21116, ובמקום זאת ייעשה שימוש ב-TCP 21116."),
        ("server-oss-not-support-tip", "הערה: גרסת ה-OSS של שרת PLNAssist אינה כוללת תכונה זו."),
