...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "PLNAssist może nie działać poprawnie na maszynie zdalnej z przyczyn związanych z UAC. W celu uniknięcia problemów z UAC, kliknij poniższy przycisk by zainstalować PLNAssist w swoim systemie."),
        ...
        ("Discovered", "Wykryte"),
        ("install_daemon_tip", "By uruchomić PLNAssist przy starcie systemu, musisz zainstalować usługę systemową."),
        ("Remote ID", "Zdalne ID"),
        ("Paste", "Wklej"),
        ...
        ("android_input_permission_tip1", "Aby można było sterować Twoim urządzeniem za pomocą myszy lub dotyku, musisz zezwolić PLNAssist na korzystanie z usługi \"Ułatwienia dostępu\"."),
        ("android_input_permission_tip2", "Przejdź do następnej strony ustawień systemowych, znajdź i wejdź w [Zainstalowane usługi], włącz usługę [PLNAssist Input]."),
        ...
        ("Language", "Język"),
        ("Keep PLNAssist background service", "Zachowaj usługę PLNAssist w tle"),
        ("Ignore Battery Optimizations", "Ignoruj optymalizację baterii"),
        ("android_open_battery_optimizations_tip", "Jeśli chcesz wyłączyć tę funkcję, przejdź do następnej strony ustawień aplikacji PLNAssist, znajdź i wprowadź [Bateria], odznacz [Bez ograniczeń]"),
        ...
        ("Show PLNAssist", "Pokaż PLNAssist"),
        ...
        ("config_input", "By kontrolować zdalne urządzenie przy pomocy klawiatury, musisz udzielić aplikacji PLNAssist uprawnień do \"Urządzeń Wejściowych\"."),
        ("config_microphone", "Aby umożliwić zdalne rozmowy należy przyznać PLNAssist uprawnienia do \"Nagrań audio\"."),
        ...
        ("empty_lan_tip", "Ojej, wygląda na to, że nie odkryliśmy żadnych urządzeń z PLNAssist w Twojej sieci."),
        ...
        ("verify_plnassist_password_tip", "Weryfikuj hasło PLNAssist"),
        ...
        ("scam_text1", "Jeżeli rozmawiasz przez telefon z osobą której NIE ZNASZ i NIE UFASZ, która prosi Cię o uruchomienie programu PLNAssist - nie rób tego i natychmiast się rozłącz."),
        ...
        ("upgrade_plnassist_server_pro_to_{}_tip", "Proszę zaktualizować PLNAssist Server Pro do wersji {} lub nowszej!"),
        ...
        ("selinux_tip", "SELinux jest włączony na Twoim urządzeniu, co może przeszkodzić w uruchomieniu PLNAssist po stronie kontrolowanej."),
        ...
        ("powered_by_me", "Obsługiwane przez PLNAssist"),
        ...
        ("allow-only-conn-window-open-tip", "Zezwalaj na połączenie tylko wtedy, gdy okno PLNAssist jest otwarte"),
        ...
        ("floating_window_tip", "Pozwala zachować usługę PLNAssist w tle"),
        ...
        ("upgrade_remote_plnassist_client_to_{}_tip", "Proszę zaktualizować zdalny klient PLNAssist do wersji {} lub nowszej!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Domyślnie PLNAssist weryfikuje certyfikat serwera dla protokołów korzystających z TLS.\n Po włączeniu tej opcji, PLNAssist pominie etap weryfikacji i będzie kontynuował działanie w przypadku negatywnej weryfikacji."),
        ("Disable UDP", "Wyłącz protokół UDP"),
        ("disable-udp-tip", "Kontroluje, czy używać wyłącznie protokołu TCP.\nPo włączeniu tej opcji, PLNAssist nie będzie używać protokołu UDP 21116, zamiast niego będzie używać protokołu TCP 21116."),
        ("server-oss-not-support-tip", "UWAGA: Serwer OSS PLNAssist nie obsługuje tej funkcji."),
